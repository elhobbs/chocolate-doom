...
{
	u32 type;        /**< ::SDL_KEYDOWN or ::SDL_KEYUP */
	u32 timestamp;
...
{
	u32 type;                    /**< Event type, shared with all events */
...
static inline u32 SDL_SwapBE32(u32 x) {
	return ((x << 24) | ((x << 8) & 0x00FF0000) | ((x >> 8) & 0x0000FF00) | (x >> 24));
}
static inline u16 SDL_SwapBE16(u16 x) {
	return ((x << 8) | (x >> 8));
}
