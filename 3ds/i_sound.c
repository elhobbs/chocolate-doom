...
int snd_samplerate = NDSP_SAMPLE_RATE;
int mus_samplerate = 11025;// NDSP_SAMPLE_RATE;
...
extern sound_module_t sound_3ds_module;
...
void I_BindSoundVariables(void)
{
	...
	waithere("snd_musiccmd");
	M_BindStringVariable("snd_musiccmd", &snd_musiccmd);
	waithere("snd_dmxoption");
	M_BindStringVariable("snd_dmxoption", &snd_dmxoption);
	M_BindIntVariable("snd_samplerate", &snd_samplerate);
	M_BindIntVariable("mus_samplerate", &mus_samplerate);
	waithere("snd_cachesize");
	M_BindIntVariable("snd_cachesize", &snd_cachesize);
	M_BindIntVariable("opl_io_port", &opl_io_port);
	M_BindIntVariable("snd_pitchshift", &snd_pitchshift);

	//M_BindStringVariable("timidity_cfg_path", &timidity_cfg_path);
	//printf("gus_patch_path: %p\n", gus_patch_path);
	//printf("gus_patch_path: %s\n", gus_patch_path);
	//waithere("gus_patch_path");
	//M_BindStringVariable("gus_patch_path", &gus_patch_path);
	//waithere("gus_ram_kb");
	//M_BindIntVariable("gus_ram_kb", &gus_ram_kb);
	waithere("I_BindSoundVariables done");
